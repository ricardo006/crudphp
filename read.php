...
<head>
    ...
    <title>Watch GO - Listagem de Vídeos</title>
...
<body>
    <!-- Inclusão da barra de navegação de outro arquivo -->
    <?php include 'nav.php'; ?>
    ...
    <div class="container-custom card-content-scroll-actions mt-2">
        ...
        <div class="card-content-scroll card-content-scroll-cards">
            <?php
            include 'conexao.php';
        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-right transition-video" style="display: none;">
                                <div class="d-flex align-items-center justify-content-begin">
                                    ...
                                    <h6 class="mt-2 mr-2 txt-title-video">&nbsp;Texto à direita</h6>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Listagem de vídeos em scroll vertical -->
